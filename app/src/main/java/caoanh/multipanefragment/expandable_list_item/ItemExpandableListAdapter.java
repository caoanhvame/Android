...
public class ItemExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public ItemExpandableListAdapter(Context context, List<String> expandableListTitle,
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view,
		...
		ViewHolderFull holder = null;
		ViewHolderShort holder2 = null;
		//		final ItemObject2 item = allItems.get(i);
		if (item.isExpand()) {
			if (view == null || view.getTag() instanceof ViewHolderShort) {
				LayoutInflater inflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
				view = inflater.inflate(R.layout.fragment_item_list_cell_full, null);
			...
			if (view == null || view.getTag() instanceof ViewHolderFull) {
				LayoutInflater inflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
				view = inflater.inflate(R.layout.fragment_item_list_cell_short, null);
	...
	public View getGroupView(int listPosition, boolean isExpanded, View convertView,
		...
		if (convertView == null) {
			...
			convertView = layoutInflater.inflate(R.layout.fragment_item_list_header, null);
		}
	...
	private void setUpgradeToImage(View view, final ViewGroup viewGroup, final ItemObject item) {
		...
		for (String itemUpgrade : item.getCreatedTo()) {
			...
			int imageName = context.getResources().getIdentifier(itemUpgrade, "drawable",
			...
			itemUpgradeImageView.setOnClickListener(new OnClickListener() {
	...
	private void setUpgradeFromImage(View view, final ViewGroup viewGroup, ItemObject item) {
		...
		for (String itemCreateFrom : item.getCreatedFrom()) {
			...
			itemFromImageView.setOnClickListener(new OnClickListener() {
